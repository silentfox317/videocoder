...
import (
	...
	toolsPkg "github.com/dirshunt/videocoder/internal/llm/tools"
...
func (c *copilotClient) exchangeGitHubToken(githubToken string) (string, error) {
	...
	req.Header.Set("User-Agent", "VideoCoder/1.0")
...
func newCopilotClient(opts providerClientOptions) CopilotClient {
	...
	openaiClientOptions = append(openaiClientOptions,
		option.WithHeader("Editor-Version", "VideoCoder/1.0"),
		option.WithHeader("Editor-Plugin-Version", "VideoCoder/1.0"),
