...
// VideoCoderTheme implements the Theme interface with VideoCoder brand colors.
// It provides both dark and light variants.
type VideoCoderTheme struct {
	BaseTheme
}

// NewVideoCoderTheme creates a new instance of the VideoCoder theme.
func NewVideoCoderTheme() *VideoCoderTheme {
	// VideoCoder color palette
	// Dark mode colors
...
func init() {
	// Register the VideoCoder theme with the theme manager
	RegisterTheme("videocoder", NewVideoCoderTheme())
}
